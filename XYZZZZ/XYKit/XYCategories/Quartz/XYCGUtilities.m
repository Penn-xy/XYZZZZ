...
//
//
//CGContextRef XYCGContextCreateARGBBitmapContext(CGSize size, BOOL opaque, CGFloat scale) {
...
//}
//
//CGContextRef XYCGContextCreateGrayBitmapContext(CGSize size, CGFloat scale) {
//    size_t width = ceil(size.width * scale);
//    size_t height = ceil(size.height * scale);
//    if (width < 1 || height < 1) return NULL;
//    
...
//    
//    return XYCGAffineTransformGetFromPoints(before, after);
//}
//
