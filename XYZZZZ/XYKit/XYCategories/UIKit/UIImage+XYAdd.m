...
static NSTimeInterval _xy_CGImageSourceGetGIFFrameDelayAtIndex(CGImageSourceRef source, size_t index) {
...
+ (UIImage *)imageWithSmallGIFData:(NSData *)data scale:(CGFloat)scale {
    ...
    for (size_t i = 0; i < count; i++) {
        NSTimeInterval delay = _xy_CGImageSourceGetGIFFrameDelayAtIndex(source, i);
        totalTime += delay;
