 ...
 */
typedef NS_OPTIONS(NSUInteger, XYNetworkTrafficType) {
    XYNetworkTrafficTypeWWANSent     = 1 << 0,
    XYNetworkTrafficTypeWWANReceived = 1 << 1,
    XYNetworkTrafficTypeWIFISent     = 1 << 2,
    XYNetworkTrafficTypeWIFIReceived = 1 << 3,
    XYNetworkTrafficTypeAWDLSent     = 1 << 4,
    XYNetworkTrafficTypeAWDLReceived = 1 << 5,
    
    XYNetworkTrafficTypeWWAN = XYNetworkTrafficTypeWWANSent | XYNetworkTrafficTypeWWANReceived,
    XYNetworkTrafficTypeWIFI = XYNetworkTrafficTypeWIFISent | XYNetworkTrafficTypeWIFIReceived,
    XYNetworkTrafficTypeAWDL = XYNetworkTrafficTypeAWDLSent | XYNetworkTrafficTypeAWDLReceived,
    
    XYNetworkTrafficTypeALL = XYNetworkTrafficTypeWWAN |
    XYNetworkTrafficTypeWIFI |
    XYNetworkTrafficTypeAWDL,
};
